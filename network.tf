...
resource "ibm_security_group" "sg_public_ans" {
  name        = "sg_public_ans"
...
resource "ibm_security_group_rule" "https-pub" {
  ...
  port_range_max    = 443
  protocol          = "tcp"
  security_group_id = "${ibm_security_group.sg_public_ans.id}"
}
...
resource "ibm_security_group_rule" "ssh-pub" {
  direction         = "ingress"
  ether_type        = "IPv4"
  port_range_min    = 22
  port_range_max    = 22
...
resource "ibm_security_group" "sg_private_ans" {
  name        = "sg_private_ans"
...
resource "ibm_security_group_rule" "ssh" {
  ...
  security_group_id = "${ibm_security_group.sg_private_ans.id}"
}
